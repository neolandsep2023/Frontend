      ...
      <FlexDir minHeight="100vh" width="100vw" direction="column" margin="0">
        <FlexDir direction="row" gap="5vw" height="100%" width="100%" padding="3rem" mediaqueryDirTablet="column" mediaqueryDirMobile="column">
          ...
          <FlexDir height="90%" mediaqueryWidth="90vw" margin={isTablet && "5rem 0 0 0"}>
            {isTablet &&
              <>
                <SearchImgCustom marginTop="-10rem" src="https://th.bing.com/th/id/R.cacb1b68ccf6fd5ff79b9e3734cc2196?rik=Ryuz9Yc6wDySsw&riu=http%3a%2f%2fwww.travelweekly.com.au%2fwp-content%2fuploads%2f2014%2f09%2fIMG_6289-r2.jpg&ehk=OWeyAb9BhmWbBMYXNbl8JZUcoXDxGC13FJb3ubE0Uh0%3d&risl=&pid=ImgRaw&r=0" />
                <SearchImgCustom marginTop="0rem" src="https://th.bing.com/th/id/OIP.UB7BT3YPQjpidUcKh6Rp-gExDM?w=281&h=188&c=7&r=0&o=5&pid=1.7" />
                <SearchImgCustom marginTop="-10rem" src="https://th.bing.com/th/id/R.91dcd1006a674569e23c0c258159b4ce?rik=Vn0uEeoPKp3Hww&pid=ImgRaw&r=0" />
              </>}
            ...
            <SearchImgCustom marginTop={isTablet ? "0rem" : "10rem"} src="https://hips.hearstapps.com/hmg-prod/images/living-room-ideas-lb-avery-cox-virginia-highlands2576-v2-1670968227.jpg" />
            {isTablet &&
              <>
                <SearchImgCustom marginTop="-10rem" src="https://th.bing.com/th/id/OIP.709FyhaU7oRYVOzD5XpPNgAAAA?rs=1&pid=ImgDetMain" />
                <SearchImgCustom marginTop="0rem" src="https://th.bing.com/th/id/R.d5b480889234da804d8b6529fe855a5e?rik=SnuAY8GONbIhag&pid=ImgRaw&r=0" />
                <SearchImgCustom marginTop="-10rem" src="https://theinspiredroom.net/wp-content/uploads/2014/09/Cozy-Bedroom-with-Fireplace.jpg" />
              </>}
          </FlexDir>
        </FlexDir>
