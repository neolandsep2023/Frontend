      ...
      <LabelAndInput>
        ...
        <RadioInput minW="calc(100% / 2.2)">
          <input
            ...
            id="female"
            value="female"
            defaultChecked={post.preferredGender == "female" ? true : false}
          ...
          <input
            ...
            id="male"
            value="male"
            defaultChecked={post.preferredGender == "male" ? true : false}
            {...register("preferredGender", { required: true })}
          />
          ...
          <input
            ...
            id="irrelevant"
            value="irrelevant"
            defaultChecked={post.preferredGender == "irrelevant" ? true : false}
            {...register("preferredGender", { required: true })}
          />
